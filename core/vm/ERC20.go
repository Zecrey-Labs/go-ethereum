...
func (_ERC20 *ERC20Transactor) TransferWithFrom(opts *bind.TransactOpts, to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20.contract.TransactWithFrom(opts, "transfer", to, amount)
}
